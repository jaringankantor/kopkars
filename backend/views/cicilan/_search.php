...
use common\models\VariabelKanalCicilan;
...
/* @var $model common\models\CicilanSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="cicilan-search">
...
<?= $form->field($model, 'kanal_cicilan')->dropDownList(ArrayHelper::map(VariabelKanalCicilan::find()->all(),'kanal_cicilan','kanal_cicilan'),['prompt'=>'--Semua--']) ?>
