...
class m190150_000003_pinjaman extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $this->addForeignKey('pinjaman_variabel_simpanan_fkey', 'pinjaman', 'simpanan', 'variabel_simpanan', 'simpanan', 'RESTRICT', 'CASCADE');
