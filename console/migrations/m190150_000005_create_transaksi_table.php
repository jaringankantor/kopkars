...
class m190150_000005_create_transaksi_table extends Migration
{
    ...
    public function safeUp()
    {
        $this->createTable('transaksi', [
            ...
            'anggota_nomor_zahir' => $this->string(20), //isi jika transaksi dilakukan oleh anggota di zahir
            'nama_pelanggan' => $this->string(20),
            ...
            'waktu' => $this->date()->notNull()->defaultExpression('now()'),
