...
class Anggota extends \yii\db\ActiveRecord implements IdentityInterface
{
    ...
    public function scenarios()
    {
        ...
        $scenarios['frontend-create-anggota'] = ['kode_toko', 'foto', 'email','password_default','re_password','nomor_hp', 'nomor_hp_last_lock', 'nomor_hp_last_lock_verified', 'nomor_pegawai'];
