...
class Anggota extends \yii\db\ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['kode_toko', 'nomor_hp_last_lock'], 'unique', 'targetAttribute' => ['kode_toko', 'nomor_hp_last_lock'], 'message'=>'No. HP telah dipakai orang lain, mohon gunakan data lain.'],
            [['kode_toko', 'nomor_zahir'], 'unique', 'targetAttribute' => ['kode_toko', 'nomor_zahir'], 'message'=>'No. Zahir telah dipakai orang lain, mohon gunakan data lain.'],
